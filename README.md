...
This reading group has two sequential tracks, each spanning five weeks with two topics per session:

| Weeks | Track | Focus |
|-------|-------|-------|
| 1–5 | **AI for Research** | Practical AI techniques that power modern research workflows |
| 6–10 | **Applied Empirics** | Core causal inference and econometric methods applied in business/economics research |

Each session features two one-hour presentations on the same track:
...
**[AI for Research](https://velikov-mihail.github.io/ai-econ-wiki/)** (Weeks 1–5) draws on recent developments in agentic AI systems, AI coding assistants, and autonomous research pipelines, aiming to equip participants with practical skills to integrate modern AI tools into their own research workflows.

**Applied Empirics** (Weeks 6–10) follows the structure of [Goldsmith-Pinkham's Applied Methods course](https://github.com/paulgp/applied-methods-phd) and [Sant'Anna's DID resources](https://psantanna.com/did-resources/), covering canonical identification strategies (DID, IV, RDD) and modern ML-based causal inference methods, with emphasis on assumptions, simulations, and hands-on replication.

---

## Format

### AI for Research (Weeks 1–5, 1 hour per topic)
...
2. **Implementation demo** (~15 min): Present your own implementation of the method(s) and discuss how to cross necessary technical barriers, with the help of AI.
...
### Applied Empirics (Weeks 6–10, 1 hour per topic)
...
Please [sign up](https://docs.google.com/spreadsheets/d/1av1Zpzm4U140xW02cjVyymvDjQ8gSTv050DII3wAeE4/edit?usp=sharing) for **one AI session** (Weeks 1–5) and **one Empirics session** (Weeks 6–10), or more if needed. Each Empirics speaker should **select an empirical paper of his/her own choice** for the replication exercise.

| Week | Date (Tentative) | Track | Topic A Presenter | Topic B Presenter |
|------|-------------------|-------|-------------------|-------------------|
| 1 | 05.18 | AI for Research | | |
| 2 | 05.25 | AI for Research | | |
| 3 | 06.02 | AI for Research | | |
| 4 | 06.09 | AI for Research | | |
| 5 | 06.16 | AI for Research | | |
| 6 | 06.23 | Applied Empirics | | |
| 7 | 06.30 | Applied Empirics | | |
| 8 | 07.07 | Applied Empirics | | |
| 9 | 07.14 | Applied Empirics | | |
| 10 | 07.21 | Applied Empirics | | |

---

## Weekly Schedule

### AI for Research (Weeks 1–5)

| Week | Topic A (9:30–10:30) | Topic B (10:30–11:30) | Key References |
|------|----------------------|-----------------------|----------------|
| 1 | AI Coding Agents & Multi-Agent Workflows for Research | AI-Powered Statistical Analysis: StatsClaw & Code Generation | [Substack](https://paulgp.substack.com/p/getting-started-with-claude-code), [GitHub](https://github.com/pedrohcgs/claude-code-my-workflow), [GitHub](https://github.com/statsclaw) |
| 2 | AI-Driven Replication Studies | Autonomous Research Systems | [GitHub](https://github.com/andybhall/vbm-replication-extension), [arXiv](https://arxiv.org/abs/2602.16733), [GitHub](https://github.com/karpathy/autoresearch), [GitHub](https://github.com/sakanaai/ai-scientist-v2) |
| 3 | Knowledge Management with LLMs: Wiki vs. RAG | AI for Data Collection & Unstructured Data | [Gist](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f), [Project APE](https://ape.socialcatalystlab.org/), [GitHub](https://github.com/velikov-mihail/AI-Powered-Scholarship) |
| 4 | LLM Social Simulations for Economic & Social Research | AI for Academic Writing & Peer Review | [GitHub](https://github.com/camel-ai/oasis), [GitHub](https://github.com/tsinghua-fib-lab/AgentSociety), [Project APE](https://ape.socialcatalystlab.org/), [GitHub](https://github.com/sakanaai/ai-scientist-v2) |
| 5 | AI for Theoretical Model Building & Mathematical Proof | Building Your AI-Augmented Research Workflow | [Vibe Research](https://vincent.codes.finance/posts/vibe-research-paper/), [Wiki](https://velikov-mihail.github.io/ai-econ-wiki/), [Substack](https://paulgp.substack.com/p/research-in-the-time-of-ai), [GitHub](https://github.com/pedrohcgs/claude-code-my-workflow) |

### Applied Empirics (Weeks 6–10)

| Week | Topic A (9:30–10:30) | Topic B (10:30–11:30) | Key References |
|------|----------------------|-----------------------|----------------|
| 6 | Propensity Scores, Matching & Reweighting | Classic DID (2×2) | [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/03_propensity_scores.pdf), [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/13_dind.pdf), [Slides](https://psantanna.com/DiD/02_two_by_two.pdf) |
| 7 | Modern DID: Staggered Adoption & TWFE Problems | Event Studies, Synthetic Control & Synthetic DID | [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/13b_dind_staggered.pdf), [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/14_synthetic_dind.pdf), [Slides](https://psantanna.com/DiD/08_ES.pdf) |
| 8 | IV: Core Theory | IV Extensions: Bartik, Shift-Share & Examiner Designs | [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/15_iv_partI.pdf), [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/16_iv_partII.pdf), [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/17_iv_partIII.pdf) |
| 9 | RDD: Sharp, Fuzzy & Extensions | Double/Debiased Machine Learning | [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/20_regression_discontinuity_1.pdf), [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/23_machine_learning_1.pdf), [Slides](https://psantanna.com/DiD/06_DML.pdf) |
| 10 | ML × Causal Inference | Partial Identification & Sensitivity Analysis | [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/25_machine_learning_3.pdf), [Slides](https://github.com/paulgp/applied-methods-phd/blob/main/lectures/26_partial_identification.pdf), [Slides](https://github.com/rphilipzhang/AI-PhD-S25/blob/main/Slides/AI-PhD-S2025-12-HTE.pdf) |

---

### Week 1 (May 18) — AI for Research

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **AI Coding Agents & Multi-Agent Workflows for Research**: Claude Code, Cursor, orchestrator patterns, quality gates, adversarial critic-fixer, CLAUDE.md/MEMORY.md | _TBD_ |
| 10:30–11:30 | **AI-Powered Statistical Analysis: StatsClaw & Code Generation**: Natural language to production-ready statistical code, comparison of tools | _TBD_ |


**Topic A References (AI Coding Agents & Multi-Agent Workflows):**
...
**Topic B References (AI-Powered Statistical Analysis):**
...
### Week 2 (May 25) — AI for Research

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **AI-Driven Replication Studies**: End-to-end replication with AI, verification workflows, credibility and reproducibility at scale | _TBD_ |
| 10:30–11:30 | **Autonomous Research Systems**: Project APE, Karpathy's autoresearch, AI Scientist, LLM-as-judge, quality assessment at scale | _TBD_ |


**Topic A References (AI-Driven Replication Studies):**
...
**Topic B References (Autonomous Research Systems):**
...
### Week 3 (June 2) — AI for Research

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **Knowledge Management with LLMs: Wiki vs. RAG**: Karpathy's LLM wiki pattern, persistent knowledge bases, applications to literature reviews | _TBD_ |
| 10:30–11:30 | **AI for Data Collection & Unstructured Data**: Web scraping, NLP pipelines, text-as-data, embeddings for research | _TBD_ |


**Topic A References (Knowledge Management with LLMs):**
...
**Topic B References (AI for Data Collection & Unstructured Data):**
...
### Week 4 (June 9) — AI for Research

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **LLM Social Simulations for Economic & Social Research**: Homo Silicus, generative agents, agent-based social simulation, validation challenges | _TBD_ |
| 10:30–11:30 | **AI for Academic Writing & Peer Review**: Drafting, proofreading agents, LLM-assisted review, ethics and disclosure | _TBD_ |


**Topic A References (LLM Social Simulations):**
...
**Topic B References (AI for Academic Writing & Peer Review):**
...
### Week 5 (June 16) — AI for Research

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **AI for Theoretical Model Building & Mathematical Proof**: LLM-assisted formalization, theorem proving, model derivation, economic theory with AI | _TBD_ |
| 10:30–11:30 | **Building Your AI-Augmented Research Workflow**: Integrating tools into a personal research pipeline, lessons learned, group discussion on adoption | _TBD_ |


**Topic A References (AI for Theoretical Model Building & Mathematical Proof):**
...
**Topic B References (Building Your AI-Augmented Research Workflow):**
...
### Week 6 (June 23) — Applied Empirics

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **Propensity Scores, Matching & Reweighting**: IPW, doubly robust estimation, overlap diagnostics | _TBD_ |
| 10:30–11:30 | **Classic DID (2×2)**: Parallel trends, inference with clustering, covariate adjustment, functional form sensitivity | _TBD_ |


**Topic A References (Propensity Scores, Matching & Reweighting):**
...
**Topic B References (Classic DID):**
...
### Week 7 (June 30) — Applied Empirics

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **Modern DID: Staggered Adoption & TWFE Problems**: Bacon decomposition, negative weights, Callaway & Sant'Anna (2021), Sun & Abraham (2021), de Chaisemartin & D'Haultfoeuille (2020) | _TBD_ |
| 10:30–11:30 | **Event Studies, Synthetic Control & Synthetic DID**: Dynamic treatment effects, pre-trend testing, SC estimation, SDID | _TBD_ |


**Topic A References (Modern DID):**
...
**Topic B References (Event Studies, Synthetic Control & Synthetic DID):**
...
### Week 8 (July 7) — Applied Empirics

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **IV: Core Theory**: Exclusion restriction, relevance, monotonicity, LATE, 2SLS, weak instruments | _TBD_ |
| 10:30–11:30 | **IV Extensions: Bartik, Shift-Share & Examiner Designs**: Simulated instruments, judge IV, practical diagnostics | _TBD_ |


**Topic A References (IV: Core Theory):**
...
**Topic B References (IV Extensions):**
...
### Week 9 (July 14) — Applied Empirics

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **RDD: Sharp, Fuzzy & Extensions**: Identification, bandwidth selection, manipulation testing, RD checklist | _TBD_ |
| 10:30–11:30 | **Double/Debiased Machine Learning**: Neyman orthogonality, cross-fitting, partially linear models, DML for ATE/CATE, IV and panel settings | _TBD_ |


**Topic A References (RDD):**
...
**Topic B References (Double/Debiased Machine Learning):**
...
### Week 10 (July 21) — Applied Empirics

| Time | Topic | Presenter |
|------|-------|-----------|
| 9:30–10:30 | **ML × Causal Inference**: Causal forests, heterogeneous treatment effects (CATE), prediction vs. inference, policy learning | _TBD_ |
| 10:30–11:30 | **Partial Identification & Sensitivity Analysis**: Bounds under weaker assumptions, sensitivity of causal estimates, Rambachan & Roth (2023) | _TBD_ |

**Topic A References (ML × Causal Inference):**
...
**Topic B References (Partial Identification & Sensitivity Analysis):**
